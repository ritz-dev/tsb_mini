...
class _RewardMarchantState extends State<RewardMarchant> {
  final List<Map<String, dynamic>> categories = [
    {"icon": "assets/reward/category_all.png", "name": "All"},
    {"icon": "assets/reward/category_drink.png", "name": "Drink"},
    {"icon": "assets/reward/category_food.png", "name": "Food"},
    {"icon": "assets/reward/category_shopping.png", "name": "Shopping"},
    {"icon": "assets/reward/category_drink.png", "name": "Drink"},
    {"icon": "assets/reward/category_food.png", "name": "Food"},
    {"icon": "assets/reward/category_shopping.png", "name": "Shopping"},
  ];
